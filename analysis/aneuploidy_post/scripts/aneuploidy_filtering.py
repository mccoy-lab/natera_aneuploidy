...
if __name__ == '__main__':
    ...
    aneuploidy_df = mark_day3(aneuploidy_df)
    ...
    aneuploidy_df['embryo_noise_sd_filter'] = (aneuploidy_df.sigma_embryo_mean.values >= mean_noise + sd_filter*sd_noise) | (aneuploidy_df.sigma_embryo_mean.values <= mean_noise - sd_filter*sd_noise)
