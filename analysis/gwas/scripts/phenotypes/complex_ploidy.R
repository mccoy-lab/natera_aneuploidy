## Generate phenotype file for complex aneuploidies: aneuploidies affecting at least one chromosome from each parent 
...
# Usage: 
# /scratch16/rmccoy22/scarios1/natera_aneuploidy/analysis/gwas/scripts/phenotypes/complex_ploidy.R \ 
# /scratch16/rmccoy22/scarios1/natera_aneuploidy/analysis/gwas/results/phenotypes/complex_ploidy_by_mother.csv \
# mother \ 
