## Make phenotype file for embryos affected by paternal haploidy (cn = 1m for a number above the threshold)
...
# Usage: 
# /scratch16/rmccoy22/scarios1/natera_aneuploidy/analysis/gwas/scripts/phenotypes/paternal_haploidy.R \ 
# /scratch16/rmccoy22/scarios1/natera_aneuploidy/analysis/gwas/results/phenotypes/paternal_haploidy_by_father.csv \
# father \ 
