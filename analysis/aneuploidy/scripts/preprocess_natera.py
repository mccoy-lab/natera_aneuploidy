...
if __name__ == "__main__":
    ...
    for v,c in zip(snakemake.input['vcf_file'], snakemake.params['chroms']):
        ...
        chrom_dict = main(child_csv=snakemake.input['child_data'], cytosnp_map=snakemake.input['cytosnp_map'], alleles_file=snakemake.input['alleles_file'], cytosnp_cluster=snakemake.input['egt_cluster'], norm_xy=None, raw_xy=None, meanr=None, vcf_file=v, mother_id=snakemake.wildcards['mother_id'], father_id=snakemake.wildcards['father_id'])
